...
function salesOrderExportHref(state: ListState): string {
  return salesOrderHref({ ...state, page: 1, pageSize: 20 }, 1).replace(
    "/sales-orders",
